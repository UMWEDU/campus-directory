...
<rss version="2.0"
	...
	<?php do_action( 'saumag-contact-taxonomy-feed-ns' ); ?>
>
...
<channel>
	...
	<item>
		...
		<link><?php echo get_term_link( $term ) ?></link>
		<pubDate><?php echo date( 'D, d M Y H:i:s +0000' ); ?></pubDate>

		<guid isPermaLink="false"><?php echo get_term_link( $term ) ?></guid>
		...
		<wfw:commentRss><?php echo esc_url( trailingslashit( get_term_link( $term ) ) . 'feed/' ); ?></wfw:commentRss>
